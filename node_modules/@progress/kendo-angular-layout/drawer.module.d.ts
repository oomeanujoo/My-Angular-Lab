...
import * as i1 from "./drawer/item.component";
import * as i2 from "./drawer/list.component";
import * as i3 from "./drawer/drawer.component";
import * as i4 from "./drawer/drawer-container.component";
import * as i5 from "./drawer/drawer-content.component";
import * as i6 from "./drawer/template-directives/drawer-template.directive";
import * as i7 from "./drawer/template-directives/header-template.directive";
